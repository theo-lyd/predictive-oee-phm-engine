...
con.execute("DROP TABLE IF EXISTS bronze_nasa_train")
con.execute("DROP TABLE IF EXISTS bronze_nasa_test")
con.execute("CREATE TABLE bronze_nasa_train AS SELECT * FROM train_df")
con.execute("CREATE TABLE bronze_nasa_test AS SELECT * FROM test_df")
con.close()
print("NASA Turbofan train/test data ingested into DuckDB (bronze_nasa_train, bronze_nasa_test)")
