...
| 8   | Baseline ML Models                              | Train and validate Linear Regression, Random Forest models                  | 8               | ML Engineer             | 4      | Baseline model benchmarks                    |
| 9   | Advanced ML Model (XGBoost)                     | Train and validate XGBoost model                                            | 5               | ML Engineer             | 4      | Advanced model benchmark                     |
| 10  | Segmentation & Clustering                       | Implement K-means clustering for degradation patterns                       | 5               | ML Engineer             | 4      | Asset clusters and pattern insights           |
| 11  | Model Evaluation & Explainability               | RMSE, MAE, and explainability artifacts                                     | 5               | ML Engineer             | 4      | Model evaluation report                      |
