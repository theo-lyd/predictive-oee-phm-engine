...
DEMO_SCENARIOS = [
    ...
    {"role": "Quality Assurance", "question": "Are there any compliance issues for Line 4?"},
    {"role": "Operations Analyst", "question": "How can we improve throughput for Line 5?"},
]
...
if user_query and openai_api_key:
    ...
    system_prompt = role_templates.get(role, f"You are a {role} at a factory. Answer root-cause questions with actionable, role-specific insights.")
