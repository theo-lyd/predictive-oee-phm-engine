...
# Sidebar: Select asset/unit and stakeholder role
...
user_query = st.text_input("Ask a root-cause question about this asset (e.g., 'Why is Line 4 failing?'):")
...
if user_query and openai_api_key:
    ...
    prompt = f"You are a {role} at a factory. Given the following context, answer the user's root-cause question in a way that is actionable and relevant for your role.\nContext:\n{context}\n\nQuestion: {user_query}\nAnswer:"
    try:
        completion = openai.ChatCompletion.create(
            model="gpt-3.5-turbo",
            messages=[{"role": "system", "content": f"You are a {role} at a factory. Answer root-cause questions with actionable, role-specific insights."},
